...
describe('useHistory', () => {
  ...
  it('should select conversation', async () => {
    ...
    ;(chatApi.getConversationHistory as jest.Mock).mockResolvedValue(mockMessages)
  ...
  it('should delete conversation', async () => {
    ;(chatApi.listConversations as jest.Mock).mockResolvedValue([
      { id: 1, title: 'Conv 1', lastMessageAt: '2024-01-01T00:00:00Z', messageCount: 2 },
      { id: 2, title: 'Conv 2', lastMessageAt: '2024-01-02T00:00:00Z', messageCount: 1 },
    ])
    ;(chatApi.deleteConversation as jest.Mock).mockResolvedValue(undefined)
