...
describe('ConversationList', () => {
  it('should show empty message when no conversations', () => {
    renderWithTheme(
      <ConversationList conversations={[]} onSelect={jest.fn()} onDelete={jest.fn()} activeId={null} />,
    )
  ...
  it('should render conversation items', () => {
    renderWithTheme(
      <ConversationList conversations={conversations} onSelect={jest.fn()} onDelete={jest.fn()} activeId={null} />,
    )
  ...
  it('should call onSelect when an item is clicked', () => {
    ...
    renderWithTheme(
      <ConversationList conversations={conversations} onSelect={onSelect} onDelete={jest.fn()} activeId={null} />,
    )
